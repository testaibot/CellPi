...
temp1 = seurat_analyse_mtx(curr_proc1[,get_cell_names_by_ident(temp, "1")], regress = F, regress_cc = NULL, do.magic = F)
...
temp3 = seurat_analyse_mtx(curr_proc1[,get_cell_names_by_ident(temp2, "1")], regress = F, regress_cc = NULL, do.magic = F)
...
plot_seur_3d(curr, radius = 0.3, lvls = NULL)
