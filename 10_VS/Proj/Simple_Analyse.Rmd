...
# 
# temp2 = seurat_analyse_mtx(curr_proc1[,get_cell_names_by_ident(temp1, "1")], regress = F, regress_cc = NULL, do.magic = F)
# table(get_orig_ident(temp2), get_ident(temp2))
# 
# temp3 = seurat_analyse_mtx(curr_proc1[,get_cell_names_by_ident(temp2, "2")], regress = F, regress_cc = NULL, do.magic = F)
...
plot_seur_3d(curr$obj, radius = 0.3)
