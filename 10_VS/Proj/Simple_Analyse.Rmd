...
rec_final = cluster_recursive(curr_proc, regress = F, regress_cc = NULL, do.magic = F, search_markers = T)
rec_final0 = cluster_recursive(curr_proc0, regress = F, regress_cc = NULL, do.magic = F, search_markers = T)
rec_final1 = cluster_recursive(curr_proc1, regress = F, regress_cc = NULL, do.magic = F, search_markers = T)
rec_final2 = cluster_recursive(curr_proc2, regress = F, regress_cc = NULL, do.magic = F, search_markers = T)
rec_final3 = cluster_recursive(curr_proc3, regress = F, regress_cc = NULL, do.magic = F, search_markers = T)
rec_final4 = cluster_recursive(curr_proc4, regress = F, regress_cc = NULL, do.magic = F, search_markers = T)
rec_final5 = cluster_recursive(curr_proc5, regress = F, regress_cc = NULL, do.magic = F, search_markers = T)
...
library(SC3)
 ...
 #sce = sce_norm(curr_proc) #sce_norm(ceiling(merged_seur@raw.data))
 sce = sc3(sce, ks = c(2,4,8), biology = F, gene_filter = F)
...
plot_seur_3d(curr$obj, radius = 3, lvls = 4, method = "pca")
