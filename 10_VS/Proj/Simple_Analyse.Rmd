...
# 
# temp3 = split_ident(temp2$obj, "s112", regress = F, regress_cc = NULL, do.magic = F, search_markers = F)
# table(get_orig_ident(temp3$obj), get_ident(temp3$obj))
# 
# temp4 = split_ident(temp3$obj, "s1121", regress = F, regress_cc = NULL, do.magic = F, search_markers = F)
...
# sce = sce_norm(curr_proc1) #sce_norm(ceiling(merged_seur@raw.data))
# sce = sc3(sce, ks = c(2,4,8,16), biology = F, gene_filter = F)
# table(sce@colData$X, sce@colData$sc3_16_clusters)
...
# table(markers_novo$cluster)
 ...
 DimPlot(curr$obj, reduction.use = "pca", group.by = "orig.ident", dim.1 = 1, dim.2 = 2)
