...
rec_final5 = cluster_recursive(curr_proc5, regress = F, regress_cc = NULL, do.magic = F, search_markers = F)
 ...
 temp = split_ident(CreateSeuratObject(raw.data = curr_proc1), regress = F, regress_cc = NULL, do.magic = F, search_markers = F)
...
# 
# temp2 = split_ident(temp1$obj, "s21", regress = F, regress_cc = NULL, do.magic = F, search_markers = F, method = "custom")
