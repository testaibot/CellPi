...
{
  if(length(table(get_types(colnames(curr_assay)))) < ncol(sce)/2)
  {
  ...
  curr_assay <-tryCatch(counts(sce), error = function(e) {})
  ...
  curr_assay <- mtx_gene_annot_convert_to(curr_assay, "ENSEMBL")
  return(curr_assay)
}
